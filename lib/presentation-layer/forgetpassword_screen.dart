...
import 'package:spicy/presentation-layer/verification-password-screen.dart';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              CustomButton(text: 'Next', color: const Color(0xFF3AB44E), textColor: Colors.white,width: 0.88, function: () { Navigator.push(context, MaterialPageRoute(builder: (context)=>VerificationPasswordScreen())); },),
            ],
          ),
        ),
      ),
